...
const Container = styled.div<{ $isHomePage: boolean; $isMobile: boolean }>`
  ...
  filter: drop-shadow(-0.5rem 0 0.5rem rgb(0 0 0 / 1%))
    drop-shadow(0.5rem 0 0.5rem rgb(0 0 0 / 1%))
    drop-shadow(0 0.5rem 0.5rem rgb(0 0 0 / 1%));
